...
def condconv_resnet18(pretrained=False, **kwargs):
...
def condconv_resnet34(pretrained=False, **kwargs):
...
def condconv_resnet50(pretrained=False, **kwargs):
...
def condconv_resnet101(pretrained=False, **kwargs):
...
def condconv_resnet152(pretrained=False, **kwargs):
...
def demo():
    net = condconv_resnet50(num_classes=1000)
